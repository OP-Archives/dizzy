...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route hydrateFallbackElement={<Loading logo={logo} />}>
      <Route element={<MainLayout />}>
        <Route path="/" element={<Vods logo={logo} />} loader={vodsLoader} />
        <Route path="/vods" element={<Vods logo={logo} />} loader={vodsLoader} />
        <Route path="/library" element={<ChaptersLibrary logo={logo} />} loader={chaptersLoader} />
